...
const DayNavigator = ({ 
  ...
  return (
    <div
      className="relative overflow-hidden rounded-2xl p-6 shadow-lg border backdrop-blur-sm transition-all duration-300 hover:shadow-xl"
      style={{ 
    ...
    >
      ...
      {/* Progress Dots */}
      <div className="flex justify-center items-center space-x-2.5 mb-1">

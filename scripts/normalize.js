...
key = key
.replace(/[\s&/-]+/g, ‘*’)   // Replace spaces, ampersands, slashes, hyphens with underscore
.replace(/[^a-z0-9*]/g, ‘’)  // Remove any remaining non-alphanumeric_underscore characters
.replace(/__+/g, ‘*’)        // Collapse multiple underscores
.replace(/^*+|_+$/g, ‘’);    // Trim leading/trailing underscores
...
// 10. Final cleanup
key = key.replace(/__+/g, ‘*’).replace(/^*+|_+$/g, ‘’);

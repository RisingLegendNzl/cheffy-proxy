...
const canonModulePath = path.join(apiDir, '_canon.js'); // Output module
...
export const CANON_VERSION = "${buildReport.version}";

export const CANON = ${JSON.stringify(sortedCanonObject, null, 2)};
 ...
 */
export const canonGet = (key) => CANON[key] || null;
`;
